...
export default async function Page() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
      <h1 className="text-4xl font-extrabold text-amber-400 mb-4 drop-shadow-lg text-center">
      ...
      <div className="max-w-xl text-center space-y-4">
        <p className="text-lg text-gray-300">
          This is a <span className="font-semibold text-amber-300">simple application</span> that demonstrates how to use <span className="text-primary">HarperDB</span> with <span className="text-blue-400">Next.js</span>.
        </p>
